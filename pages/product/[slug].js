    ...
    <div className='w-full md:py-20'>
      <ToastContainer/>
        <Wrapper>
            ...
            {/*left column start */}
            <div className='w-full md:w-auto flex-[1.5] max-w-[500px] lg:max-w-full mx-auto lg:mx-0'><ProductDetailsCarousel
             images={p.image.data} /></div>
             {/*left column end */}
            ...
            <div className='flex-[1] py-3'>
              ...
              {/* Product Subtitle */}
              <div className='text-lg mb-5 fonts=-semibold'>{p.subtitle}</div>

              {/* Product Price */}
             <div className='flex items-center'>
                 <p className='mr-2 text-lg font-femibold'>
                  MRP : &#8377;{p.price}
                 </p>
                ...
                <div className='mb-10'>
                  ...
                  <div id="sizesGrid" className='grid grid-cols-3 gap-2'>
                    {p.size.data.map((item,i)=>(
                     ...
                     <div key={i} className={`border rounded-md text-center py-3 font-medium ${item.enabled ?'hover:border-black cursor-pointer' : 'bg-black/[0.1] opacity-50 cursor-not-allowed'} ${selectedSize==item.size ? "border-black":"" }   `} 
